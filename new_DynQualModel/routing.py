...
class Routing(object):
    ...
    def __init__(self,iniItems,initialConditions,lddMap):
        ...
        ####Required for offline DynQual runs####
    ...
    def readPollutantLoadingsInputData(self, currTimeStep, landSurface, groundwater):
        ...
        if iniItems.routingOptions['offlineRun'] == "False":        
            self.USR_RF = landSurface.directRunoff * self.urban_area_fraction * self.cellArea #in m3/day
        else:
