...
def print_disclaimer(with_logger = False):
    ...
    disclaimer_message  =                                                                                                   "\n"
    disclaimer_message +=                                                                                                   "\n"
    disclaimer_message += " PCR-GLOBWB 2 (PCRaster Global Water Balance) Global Hydrological Model                     "  + "\n"
    disclaimer_message +=                                                                                                   "\n"
    ...
    disclaimer_message +=                                                                                                   "\n"
    disclaimer_message += " DynQual (Dynamic Quality) Global Water Quality Model v1.0"                                    + "\n"
    disclaimer_message += " Edward R. Jones, Michelle T.H. van Vliet, Niko Wanders,"                                      + "\n"
    disclaimer_message += " Edwin H. Sutanudjaja, Rens van Beek, and Marc F. P. Bierkens"                                 + "\n"
    disclaimer_message += " Faculty of Geosciences, Utrecht University, Utrecht, The Netherlands"                         + "\n"    
    disclaimer_message +=                                                                                                   "\n"
