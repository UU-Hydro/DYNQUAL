...
# Faculty of Geosciences, Utrecht University, Utrecht, The Netherlands
#
# This script is designed for running offline DynQual runs in parallel (self.offline = True)
# In this configuration, hydrology must be prescribed (interflow, baseflow, surface runoff).
#
...
for clone_code in clone_codes:
   ...
   cmd += "python deterministic_runner_glue_with_parallel_and_modflow_options_offline.py " + iniFileName  + " " + debug_option + " " + clone_code + " "
   cmd = cmd + " & "
   i_clone += 1
